...
/// TEMP: This structure is currently used in the refactoring work to move everything
/// into event based structure. This is the initial implementation state structure.
#[derive(Debug)]
pub struct State {
    pub loan: i64,
